        ...
        <div data-aos="fade-up" style="max-width:1200px; margin:0 auto; display:grid; grid-template-columns: repeat(auto-fit, minmax(200px,1fr)); gap:28px; align-items:start;">
          ...
          <div style="min-width:220px;">
            ...
            <div style="display:flex; gap:12px; flex-wrap:wrap;">
              <a href="#" title="Twitter" style="display:inline-flex;align-items:center;justify-content:center;width:50px;height:50px;border-radius:10px;background:rgba(255,255,255,0.03);text-decoration:none;">
                <i class="fa-brands fa-x-twitter" style="color:white"></i>
              </a>
              <a href="#" title="LinkedIn" style="display:inline-flex;align-items:center;justify-content:center;width:50px;height:50px;border-radius:10px;background:rgba(255,255,255,0.03);text-decoration:none;">
                <i class="fa-brands fa-linkedin" style="color:white"></i>
              </a>
              <a href="#" title="GitHub" style="display:inline-flex;align-items:center;justify-content:center;width:50px;height:50px;border-radius:10px;background:rgba(255,255,255,0.03);text-decoration:none;">
                <i class="fa-brands fa-github" style="color:white"></i>
              </a>
              <a href="#" title="Website" style="display:inline-flex;align-items:center;justify-content:center;width:50px;height:50px;border-radius:10px;background:rgba(255,255,255,0.03);text-decoration:none;">
